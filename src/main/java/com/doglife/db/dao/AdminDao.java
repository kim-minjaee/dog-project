...
public interface AdminDao {
	...
	public List<AdoptionListDto> getDoginform(ListDto list);
	...
	public List<AdoptionListDto> adminApplicationList(ListDto list);
	...
	public int adminCountSelect(ListDto list);

	public int adminApplicationCountSelect(ListDto list);
