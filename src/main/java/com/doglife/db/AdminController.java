...
public class AdminController {
	...
	public ModelAndView adoptManagement(HttpSession session, ListDto list) {
		...
		mv = adServ.adoptManagement(session, list);		
	...
	public ModelAndView adminApplicationList(AdoptionListDto appDto, ListDto list) {
		mv = adServ.adminApplicationList(appDto, list);
