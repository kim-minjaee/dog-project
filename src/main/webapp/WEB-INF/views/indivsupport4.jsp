				...
				<div class="row no-gutters">
					...
					<c:if test="${sList.msType eq '2'}">
						<div class="col-lg-7 contact-form__wrapper p-5 order-lg-1">
							<form action="./deletesupport" method="get"
								...
								<div class="row">
									...
									<div class="col-sm-6 mb-3">
										<div class="form-group">
											...
											<label for="customerName">작성자</label> <input type="text"
												class="form-control" id="customerName" name="memberName"
												placeholder="Appleseed" value="${sList.memberName}" readonly>
									...
									<div class="col-sm-6 mb-3">
										<div class="form-group">
											<label class="required-field" for="email">이메일</label> <input
												type="text" class="form-control" id="email" name="memberId"
												placeholder="welcome@doglife.com" value="${sList.memberId}"
												readonly>
										</div>
									</div>
									...
									<div class="col-sm-6 mb-3">
										<div class="form-group">
											<label for="phone">연락처</label> <input type="tel"
												class="form-control" id="customerPnum" name="memberPnum"
									...
									<c:if test="${sList.memberId eq memberId}">
