			...
			<div class="jumbotron text-center"
				...
				<div class="col-md-10 col-md-offset-2">
					<form name="joinFrm" class="form-horizontal" role="form"
						action="./sellerInsert" method="post"
						onsubmit="return passwordCheck()">
						<div class="form-group text-center">
							<div class="col-sm-10 reg-icon">
								<span class="fa fa-user fa-3x">판매자 회원가입</span>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-sm-10">
								<input type="text" title="License" name="licenseNum"
									class="form-control" placeholder="사업자등록증">
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-10">
