...
<div class="container bootstrap snippets bootdey">
  <div class="row">
    ...
    <div class="main">
      ...
      <form name="pwdcheckFrm" action="./pwd_new" method="post" onsubmit="return check()" >
        <div class="mail_check_wrap">
          <label for="inputPassword">새로운 비밀번호</label>
          <input type="password" class="form-control" id="customerPwd1" onkeyup="passwordCheck();" name=customerPw title="비밀번호">
        </div>
        <div class="form-group">
          <label for="inputPassword">비밀번호 확인</label>
          <input type="password" class="form-control" id="customerPwd" onkeyup="passwordCheck();" name=memberPwd title="비밀번호 확인">
        </div>
...
function passwordCheck(){
	...
	var customerPwd2 = $("#customerPwd").val();
