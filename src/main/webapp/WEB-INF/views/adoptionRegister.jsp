			...
			<form action="./dogRegister" method="post" enctype="multipart/form-data">
				<div class="contain1">
					...
					<div class="contain1_product_title" >				
						<div><span class="title" style="letter-spacing: 24px">이름</span> : &nbsp; <input type="text" name="dogName" id="poption" required></div>
						<hr>
						<div class="contain1_product_title_option1">
						
							<div><span class="title" style="letter-spacing: 24px">나이</span> : &nbsp; <input type="text" name="dogAge" id="poption" required></div>
							<label class="title" style="letter-spacing: 24px" for="option">성별 </label> : &nbsp;  <select name="dogGender"
											class="form-control" id="choiceC" required>
											<option value="수컷">수컷</option>
											<option value="암컷">암컷</option>
										</select>
							<label class="title" style="letter-spacing: 24px" for="option">품종 </label> : &nbsp;  <select name="dogBreed"
											class="form-control" id="choiceC" required>
											<c:forEach var = "a" items = "${bList}">
											<option value="${a.breed}">${a.breed}</option>
											</c:forEach>
										</select>
							<label class="title" style="letter-spacing: 12px" for="option">예방접종 </label> : &nbsp;  <select name="dogVaccine"
											class="form-control" id="choiceC" required>
											<option value="1차">1차</option>
											<option value="2차">2차</option>
										</select>
							<div><span class="title" style="letter-spacing: 24px">가격</span> : &nbsp; <input type=text name="dogPrice" id="choiceC" required></div>
						</div>	
					</div>			
