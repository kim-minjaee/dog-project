					...
					<div class="col-xs-12">
						<div class="form-group">
							<input class="form-input" name="drTitle" type="text"
								placeholder="제목을 입력하세요." value="${rList.drTitle}"  required readonly>
							<textarea class="form-input" name="drContent"
								placeholder="내용을 입력하세요." rows="25" required readonly>${rList.drContent}</textarea>
						</div>
					</div>
					<hr>
			<div class="regbutton" style="text-align: center;">
				<c:if test="${rList.memberId eq memberId}">
			<input class="update1" type="submit" value="수정" >
			</c:if>
			</div>
				</div>
			</form>
