									...
									<div class="box-product">
										<div class="img-wrapper">
											<a href="./productInfo?pnum=${product.pnum}"> <img
												...
												src="./resources/upload/${product.thumbsysname}">
											</a>
											<div class="tags">
											...
											<div class="option">
												<a href="./productInfo?pnum=${product.pnum}"
										...
										<div class="price">
											<div>${product.pprice}원<span class="price-down">평점<fmt:formatNumber
														value="${product.pavg}" pattern=".0" /></span>
											</div>
										</div>
										<div class="rating">
