					...
					<div class="col-xs-12">
						<div class="form-group">
							<input class="form-input" name="srtitle" type="text"
								placeholder="제목을 입력하세요." value="${rDto.srtitle}" required>
							<textarea class="form-input" name="srcontent"
								placeholder="내용을 입력하세요." rows="25" required>${rDto.srcontent}</textarea>
						</div>
					</div>
					<hr>
							...
							<div class="review_rating">
								...
								<div class="rating">
									...
									<input type="checkbox" name="rating" id="rating1" value="1"
										class="rate_radio 1" title="1점"> <label for="rating1"></label>
									<input type="checkbox" name="rating" id="rating2" value="2"
										class="rate_radio 2" title="2점"> <label for="rating2"></label>
									<input type="checkbox" name="rating" id="rating3" value="3"
										class="rate_radio 3" title="3점"> <label for="rating3"></label>
									<input type="checkbox" name="rating" id="rating4" value="4"
										class="rate_radio 4" title="4점"> <label for="rating4"></label>
									<input type="checkbox" name="rating" id="rating5" value="5"
										class="rate_radio 5" title="5점"> <label for="rating5"></label>
								</div>
							</div>
						</div>
						<div class="regbutton">
							<input type="submit" name="files" class="regbutton" value="수정"></input>
						</div>
					</div>
			</form>
		</div>
