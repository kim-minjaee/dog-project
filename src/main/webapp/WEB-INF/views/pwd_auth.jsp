...
<div class="container bootstrap snippets bootdey">
  <div class="row">
    ...
    <div class="main">
      ...
      <form name="pwdcheckFrm" action="./pwd_set" method="post" onsubmit="return check()">
      	<input type="hidden" name="num" value="${checkNum}">
        <div class="mail_check_wrap">
          <label for="inputPassword">인증번호</label>
          <input class="form-control" id="mail_input" name=auth title="인증번호" placeholder="인증번호를 입력하세요">
        </div>
